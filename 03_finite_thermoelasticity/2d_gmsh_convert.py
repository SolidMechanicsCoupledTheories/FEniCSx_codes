...
"""
import meshio
mesh_from_file = meshio.read("meshes/bilayer_beam.msh")
...
meshio.write("meshes/facet_bilayer_beam.xdmf", line_mesh)

triangle_mesh = create_mesh(mesh_from_file, "triangle", prune_z=True)
meshio.write("meshes/bilayer_beam.xdmf", triangle_mesh)